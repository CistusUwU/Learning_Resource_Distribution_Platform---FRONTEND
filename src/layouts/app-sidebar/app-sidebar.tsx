...
export const AppSidebar: FC<AppSidebarProps> = ({
    ...
    return (
        <aside className="w-64 bg-white dark:bg-slate-800 border-r border-slate-200 dark:border-slate-700 fixed top-16 left-0 h-[calc(100vh-4rem)] overflow-y-auto z-30">
